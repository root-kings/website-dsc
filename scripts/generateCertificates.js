...
generateCertificates('Getting Started with Android', 'Roshan Paturkar', '2019/09/26', { csvpath: __dirname + '/../data/gettingStartedWithAndroid.csv', namefield: 'Name', emailfield: 'Email' })
